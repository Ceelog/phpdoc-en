...
-   [Installing/Configuring](/gearman/setup.html)
    ...
    -   [Runtime
        Configuration](/gearman/setup.html#Runtime%20Configuration)
...
**Example \#2 Basic submission of two tasks with passing application
context**
...
**Example \#1 Simple worker making use of extra application context
data**
...
**Example \#1 <span class="function">GearmanWorker::setId</span>
example**
...
**Example \#1 <span class="methodname">GearmanWorker::work</span>
example**
