...
**Example \#1 Setting and retrieving parameters through a connection
resource**
...
**Example \#1 A <span class="function">db2\_last\_insert\_id</span>
example**
...
**Example \#1 Calling a stored procedure that returns multiple result
sets**
...
<a href="/features/persistent-connections.html" class="xref">Persistent Database Connections</a>.
...
**Example \#1 A <span class="function">db2\_pconnect</span> example**
...
**Example \#1 A <span class="function">db2\_result</span> example**
...
**Example \#1 A <span class="function">db2\_server\_info</span>
example**
...
**Example \#5 Setting multiple parameters with a connection resource and
the wrong type**
