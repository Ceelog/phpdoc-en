...
The <span class="classname">MongoDB\\Driver\\Session</span> class
represents a client session and is returned by <span
class="methodname">MongoDB\\Driver\\Manager::startSession</span>.
Commands, queries, and write operations may then be associated the
session.
...
<span class="modifier">final</span> <span class="ooclass"> class
**MongoDB\\Driver\\Session** </span> {

/\* Constants \*/

<span class="modifier">const</span> <span class="type">string</span>
`MongoDB\Driver\Session::TRANSACTION_NONE` <span class="initializer"> =
none</span> ;

<span class="modifier">const</span> <span class="type">string</span>
`MongoDB\Driver\Session::TRANSACTION_STARTING` <span
class="initializer"> = starting</span> ;

<span class="modifier">const</span> <span class="type">string</span>
`MongoDB\Driver\Session::TRANSACTION_IN_PROGRESS` <span
class="initializer"> = in\_progress</span> ;

<span class="modifier">const</span> <span class="type">string</span>
`MongoDB\Driver\Session::TRANSACTION_COMMITTED` <span
class="initializer"> = committed</span> ;

<span class="modifier">const</span> <span class="type">string</span>
`MongoDB\Driver\Session::TRANSACTION_ABORTED` <span class="initializer">
= aborted</span> ;
...
class="methodname">abortTransaction</span> ( <span
class="methodparam">void</span> )

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">void</span> <span
class="methodname">advanceClusterTime</span> ( <span
class="methodparam"><span class="type">array\|object</span>
`$clusterTime`</span> )

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">void</span> <span
class="methodname">advanceOperationTime</span> ( <span
class="methodparam"><span
class="type">MongoDB\\BSON\\TimestampInterface</span>
`$operationTime`</span> )

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">void</span> <span
class="methodname">commitTransaction</span> ( <span
class="methodparam">void</span> )
...
<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">void</span> <span
class="methodname">endSession</span> ( <span
class="methodparam">void</span> )

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">object\|null</span> <span
class="methodname">getClusterTime</span> ( <span
class="methodparam">void</span> )

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">object</span> <span
class="methodname">getLogicalSessionId</span> ( <span
class="methodparam">void</span> )

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">MongoDB\\BSON\\Timestamp\|null</span> <span
class="methodname">getOperationTime</span> ( <span
class="methodparam">void</span> )

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">MongoDB\\Driver\\Server\|null</span> <span
class="methodname">getServer</span> ( <span
class="methodparam">void</span> )

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">array\|null</span> <span
class="methodname">getTransactionOptions</span> ( <span
class="methodparam">void</span> )

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">string</span> <span
class="methodname">getTransactionState</span> ( <span
class="methodparam">void</span> )

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">boolean</span> <span
class="methodname">isInTransaction</span> ( <span
class="methodparam">void</span> )

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">void</span> <span
class="methodname">startTransaction</span> (\[ <span
class="methodparam"><span class="type">array</span> `$options`</span> \]
)
...
A transaction has been started, but no operation has been sent to the
server.
...
<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">void</span> <span
class="methodname">MongoDB\\Driver\\Session::abortTransaction</span> (
<span class="methodparam">void</span> )
...
-   Throws <span
    class="classname">MongoDB\\Driver\\Exception\\RuntimeException</span>
    if the transaction could not be aborted (e.g. a transaction was not
    started).
...
-   <span
    class="methodname">MongoDB\\Driver\\Manager::startSession</span>
-   <span
    class="methodname">MongoDB\\Driver\\Session::commitTransaction</span>
-   <span
    class="methodname">MongoDB\\Driver\\Session::startTransaction</span>
...
<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">void</span> <span
class="methodname">MongoDB\\Driver\\Session::advanceClusterTime</span> (
<span class="methodparam"><span class="type">array\|object</span>
`$clusterTime`</span> )

Advances the cluster time for this session. If the cluster time is less
than or equal to the session's current cluster time, this function is a
no-op.

By using this method in conjunction with <span
class="methodname">MongoDB\\Driver\\Session::advanceOperationTime</span>
to copy the cluster and operation times from another session, you can
ensure that operations in this session are causally consistent with the
last operation in the other session.

### Parameters

`clusterTime`  
The cluster time is a document containing a logical timestamp and server
signature. Typically, this value will be obtained by calling <span
class="methodname">MongoDB\\Driver\\Session::getClusterTime</span> on
...
-   <span
    class="methodname">MongoDB\\Driver\\Session::advanceOperationTime</span>
-   <span
    class="methodname">MongoDB\\Driver\\Session::getClusterTime</span>
...
By using this method in conjunction with <span
class="methodname">MongoDB\\Driver\\Session::advanceClusterTime</span>
to copy the operation and cluster times from another session, you can
ensure that operations in this session are causally consistent with the
last operation in the other session.
...
class="methodname">MongoDB\\Driver\\Session::getOperationTime</span> on
another session object.
...
transaction and ends the transaction. Until the commit, none of the data
changes made from within the transaction are visible outside the
transaction.
...
-   Throws <span
    ...
    on argument parsing errors.
-   Throws <span
    class="classname">MongoDB\\Driver\\Exception\\CommandException</span>
    if the server could not commit the transaction (e.g. due to
    conflicts, network issues). In case the exception's <span
    class="methodname">MongoDB\\Driver\\Exception\\CommandException::getResultDocument</span>
    has a *"errorLabels"* element, and this array contains a
    *"TransientTransactionError"* or
    *"UnUnknownTransactionCommitResult"* value, it is safe to re-try the
    *whole* transaction. In newer versions of the driver, <span
...
<span class="modifier">final</span> <span
class="modifier">private</span> <span
class="methodname">MongoDB\\Driver\\Session::\_\_construct</span> (
<span class="methodparam">void</span> )

<span class="classname">MongoDB\\Driver\\Session</span> objects are
returned by <span
class="methodname">MongoDB\\Driver\\Manager::startSession</span> and
...
-   <span class="function">MongoDB\\Driver\\Manager::startSession</span>
...
<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">void</span> <span
class="methodname">MongoDB\\Driver\\Session::endSession</span> ( <span
class="methodparam">void</span> )
...
> **Note**: <span class="simpara"> Sessions are also closed during
> garbage collection. It should not be necessary to call this method
...
used for any operation and <span
class="methodname">MongoDB\\Driver\\Session::advanceClusterTime</span>
...
Returns the cluster time for this session, or **`NULL`** if the session
has no cluster time.
...
<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">object</span> <span
class="methodname">MongoDB\\Driver\\Session::getLogicalSessionId</span>
( <span class="methodparam">void</span> )
...
<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">MongoDB\\BSON\\Timestamp\|null</span> <span
class="methodname">MongoDB\\Driver\\Session::getOperationTime</span> (
<span class="methodparam">void</span> )

Returns the operation time for this session. If the session has not been
used for any operation and <span
class="methodname">MongoDB\\Driver\\Session::advanceOperationTime</span>
has not been called, the operation time will be **`NULL`**
...
Returns the operation time for this session, or **`NULL`** if the
session has no operation time.
...
<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">MongoDB\\Driver\\Server\|null</span> <span
class="methodname">MongoDB\\Driver\\Session::getServer</span> ( <span
class="methodparam">void</span> )

Returns the <span class="classname">MongoDB\\Driver\\Server</span> to
which this session is pinned. If the session is not pinned to a server,
...
instance. This method is intended to be used by libraries built atop the
extension to allow use of a pinned server instead of invoking server
selection.
...
Returns the <span class="classname">MongoDB\\Driver\\Server</span> to
which this session is pinned, or **`NULL`** if the session is not pinned
to any server.
...
<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">array\|null</span> <span
class="methodname">MongoDB\\Driver\\Session::getTransactionOptions</span>
( <span class="methodparam">void</span> )
...
Returns a <span class="type">array</span> containing current transaction
options, or **`NULL`** if no transaction is running.
...
-   <span
    class="methodname">MongoDB\\Driver\\Session::getTransactionState</span>
...
-   <span
    class="methodname">MongoDB\\Driver\\Session::isInTransaction</span>
-   <span
    class="methodname">MongoDB\\Driver\\Session::getTransactionOptions</span>
...
Returns **`TRUE`** if a transaction is currently in progress for this
...
After starting a transaction, the session object must be passed to each
operation via the *"session"* option (e.g. <span
class="methodname">MongoDB\\Driver\\Manager::executeBulkWrite</span>) in
order to associate that operation with the transaction.

Transactions can be committed through <span
class="methodname">MongoDB\\Driver\\Session::commitTransaction</span>,
and aborted with <span
class="methodname">MongoDB\\Driver\\Session::abortTransaction</span>.
Transactions are also automatically aborted when the session is closed
from garbage collection or by explicitly calling <span
class="methodname">MongoDB\\Driver\\Session::endSession</span>.
...
*"defaultTransactionOptions"* option, if set when starting the session
with <span
class="methodname">MongoDB\\Driver\\Manager::startSession</span>.
...
-   Throws <span
    class="classname">MongoDB\\Driver\\Exception\\CommandException</span>
    if the transaction could not be started because of a server-side
    problem (e.g. a lock could not be obtained).
-   Throws <span
    class="classname">MongoDB\\Driver\\Exception\\RuntimeException</span>
    if the transaction could not be started (e.g. a transaction was
    already started).
...
The <span class="classname">MongoDB\\Driver\\ClientEncryption</span>
class handles creation of data keys for client-side encryption, as well
as manually encrypting and decrypting values.
...
<span class="modifier">final</span> <span class="ooclass"> class
**MongoDB\\Driver\\ClientEncryption** </span> {
...
AEAD\_AES\_256\_CBC\_HMAC\_SHA\_512-Deterministic</span> ;

<span class="modifier">const</span> <span class="type">string</span>
`MongoDB\Driver\ClientEncryption::AEAD_AES_256_CBC_HMAC_SHA_512_RANDOM`
<span class="initializer"> =
AEAD\_AES\_256\_CBC\_HMAC\_SHA\_512-Random</span> ;

/\* Methods \*/

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">MongoDB\\BSON\\Binary</span> <span
class="methodname">createDataKey</span> ( <span
class="methodparam"><span class="type">string</span>
`$kmsProvider`</span> \[, <span class="methodparam"><span
class="type">array</span> `$options`</span> \] )

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">mixed</span> <span class="methodname">decrypt</span>
( <span class="methodparam"><span
class="type">MongoDB\\BSON\\Binary</span> `$value`</span> )

<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">MongoDB\\BSON\\Binary</span> <span
class="methodname">encrypt</span> ( <span class="methodparam"><span
...
-   <span
    class="function">MongoDB\\Driver\\Manager::createClientEncryption</span>
...
<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">MongoDB\\BSON\\Binary</span> <span
class="methodname">MongoDB\\Driver\\ClientEncryption::createDataKey</span>
( <span class="methodparam"><span class="type">string</span>
`$kmsProvider`</span> \[, <span class="methodparam"><span
class="type">array</span> `$options`</span> \] )
...
`kmsProvider`  
The KMS provider (*"local"* or *"aws"*) that will be used to encrypt the
new encryption key.
...
<td>masterKey</td>
<td><span class="type">array</span></td>
<td><p>The masterKey identifies a KMS-specific key used to encrypt the new data key. If the kmsProvider is <em>aws</em> it is required and has the following fields:</p>
<table>
...
<td>keyAltNames</td>
<td><span class="type">array</span></td>
<td><p>An optional list of string alternate names used to reference a key. If a key is created with alternate names, then encryption may refer to the key by the unique alternate name instead of by <em>_id</em>.</p></td>
</tr>
</tbody>
</table>
...
Returns the identifier of the new key as a <span
class="classname">MongoDB\\BSON\\Binary</span> object with subtype 4
(UUID).
...
-   Throws <span
    ...
    on argument parsing errors.
-   Throws <span
    class="classname">MongoDB\\Driver\\Exception\\EncryptionException</span>
    if an error occurs while creating the data key
...
class="methodname">MongoDB\\Driver\\ClientEncryption::decrypt</span> (
<span class="methodparam"><span
class="type">MongoDB\\BSON\\Binary</span> `$value`</span> )
...
`value`  
A <span class="classname">MongoDB\\BSON\\Binary</span> instance with
subtype 6 containing the encrypted value.

### Return Values

Returns the decrypted value as it was passed to <span
class="function">MongoDB\\Driver\\ClientEncryption::encrypt</span>.
...
-   Throws <span
    class="classname">MongoDB\\Driver\\Exception\\EncryptionException</span>
    if an error occurs while decrypting the value
...
<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">MongoDB\\BSON\\Binary</span> <span
class="methodname">MongoDB\\Driver\\ClientEncryption::encrypt</span> (
...
`value`  
The value to be encrypted. Any value that can be inserted into MongoDB
can be encrypted using this method.

`options`  
| Option     | Type                                                 | Description                                                                                                                         |
|------------|------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| algorithm  | <span class="type">string</span>                     | The encryption algorithm to be used. Use the constants defined in <span class="classname">MongoDB\\Driver\\ClientEncryption</span>. |
| keyAltName | <span class="type">string</span>                     | Identifies a key vault collection document by *keyAltName*.                                                                         |
| keyId      | <span class="classname">MongoDB\\BSON\\Binary</span> | Identifies a data key by *\_id*. The value is a UUID (binary subtype 4).                                                            |

> **Note**: <span class="simpara"> Exactly one of *keyId* and
> *keyAltName* must be provided. The *algorithm* option is required.
> </span>

### Return Values

Returns the encrypted value as <span
class="classname">MongoDB\\BSON\\Binary</span> object with subtype 6.
...
-   Throws <span
    class="classname">MongoDB\\Driver\\Exception\\EncryptionException</span>
    if an error occurs while encrypting the value

### See Also

-   <span
    class="function">MongoDB\\Driver\\ClientEncryption::decrypt</span>
...
<a href="/set/mongodb.html#Predefined%20Constants" class="link">class constants</a>.
...
**Example \#1 <span
class="function">MongoDB\\Driver\\Cursor::getId</span> example**
...
**Example \#1 <span
class="function">MongoDB\\Driver\\Cursor::isDead</span> example**
...
class="classname">MongoDB\\Driver\\Cursor</span> but may also be used
...
<span class="ooclass"> class **MongoDB\\Driver\\CursorInterface**
...
class="type">MongoDB\\Driver\\CursorId</span> <span
class="methodname">getId</span> ( <span class="methodparam">void</span>
)

<span class="modifier">abstract</span> <span
class="modifier">public</span> <span
class="type">MongoDB\\Driver\\Server</span> <span
class="methodname">getServer</span> ( <span
class="methodparam">void</span> )

<span class="modifier">abstract</span> <span
class="modifier">public</span> <span class="type">bool</span> <span
class="methodname">isDead</span> ( <span class="methodparam">void</span>
)
...
class="modifier">public</span> <span
class="type">MongoDB\\Driver\\CursorId</span> <span
class="methodname">MongoDB\\Driver\\CursorInterface::getId</span> (
<span class="methodparam">void</span> )
...
-   <span class="methodname">MongoDB\\Driver\\Cursor::getId</span>
-   <span class="classname">MongoDB\\Driver\\CursorId</span>
-   <span
    class="function">MongoDB\\Driver\\CursorId::\_\_toString</span>
...
class="modifier">public</span> <span
class="type">MongoDB\\Driver\\Server</span> <span
class="methodname">MongoDB\\Driver\\CursorInterface::getServer</span> (
<span class="methodparam">void</span> )
...
<span class="modifier">abstract</span> <span
class="modifier">public</span> <span class="type">bool</span> <span
class="methodname">MongoDB\\Driver\\CursorInterface::isDead</span> (
<span class="methodparam">void</span> )

Checks whether the cursor may have additional results available to read.
A cursor is initially "alive" but may become "dead" for any of the
following reasons:
...
Returns **`TRUE`** if additional results are not available, and
**`FALSE`** otherwise.
...
-   <span class="methodname">MongoDB\\Driver\\Cursor::isDead</span>
...
<span class="modifier">abstract</span> <span
class="modifier">public</span> <span class="type">void</span> <span
class="methodname">MongoDB\\Driver\\CursorInterface::setTypeMap</span> (
<span class="methodparam"><span class="type">array</span>
`$typemap`</span> )
...
-   <span class="methodname">MongoDB\\Driver\\Cursor::setTypeMap</span>
-   <a href="/set/mongodb.html#Persisting%20Data" class="xref"></a>
...
<span class="modifier">abstract</span> <span
class="modifier">public</span> <span class="type">array</span> <span
class="methodname">MongoDB\\Driver\\CursorInterface::toArray</span> (
<span class="methodparam">void</span> )

Iterates the cursor and returns its results in an array. <span
class="function">MongoDB\\Driver\\CursorInterface::setTypeMap</span> may
be used to control how documents are unserialized into PHP values.
...
-   <span class="methodname">MongoDB\\Driver\\Cursor::toArray</span>
-   <span
    class="function">MongoDB\\Driver\\CursorInterface::setTypeMap</span>
...
**Example \#1 <span class="function">MongoDB\\BSON\\fromJSON</span>
example**
...
**Example \#1 <span class="function">MongoDB\\BSON\\fromPHP</span>
example**
...
**Example \#1 <span class="function">MongoDB\\BSON\\toJSON</span>
example**
...
**Example \#1 <span class="function">MongoDB\\BSON\\toPHP</span>
example**
...
**Example \#1 <span
class="function">MongoDB\\BSON\\Binary::getData</span> example**
...
**Example \#1 <span
class="function">MongoDB\\BSON\\Binary::getType</span> example**
...
**Example \#1 <span
class="function">MongoDB\\BSON\\Regex::getFlags</span> example**
...
-   [MongoDB\\Driver\\Exception\\CommandException](/set/mongodb.html#MongoDB\Driver\Exception\CommandException)
    — The MongoDB\\Driver\\Exception\\CommandException class
    -   [MongoDB\\Driver\\Exception\\CommandException::getResultDocument](/set/mongodb.html#MongoDB\Driver\Exception\CommandException::getResultDocument)
...
<span class="ooclass"> class
**MongoDB\\Driver\\Exception\\CommandException** </span> <span
class="ooclass"> <span class="modifier">extends</span>
...
<span class="modifier">protected</span> <span class="type">object</span>
`$resultDocument` ;
...
<span class="modifier">final</span> <span class="modifier">public</span>
<span class="type">object</span> <span
class="methodname">getResultDocument</span> ( <span
class="methodparam">void</span> )
...
<span class="ooclass"> class
**MongoDB\\Driver\\Exception\\EncryptionException** </span> <span
class="ooclass"> <span class="modifier">extends</span>
**MongoDB\\Driver\\Exception\\RuntimeException** </span> <span
class="oointerface">implements <span
class="interfacename">MongoDB\\Driver\\Exception\\Exception</span>
...
Base class for exceptions thrown by the server. The code of this
exception and its subclasses will correspond to the original error code
from the server.
...
<a href="/spl/exceptions.html" class="link">SPL Exceptions</a>. Base
classes extend their SPL counterpart and all exception classes in the
extension implement the <span
class="classname">MongoDB\\Driver\\Exception\\Exception</span>
interface.

-   <span class="simpara"><span
    class="classname">MongoDB\\Driver\\Exception\\LogicException</span>
    (extends <span class="classname">LogicException</span>)</span>
-   <span class="simpara"><span
    class="classname">MongoDB\\Driver\\Exception\\InvalidArgumentException</span>
    (extends <span
...
-   <span class="simpara"><span
    class="classname">MongoDB\\Driver\\Exception\\RuntimeException</span>
    (extends <span class="classname">RuntimeException</span>)</span>
    -   <span class="simpara"><span
        class="classname">MongoDB\\Driver\\Exception\\ConnectionException</span></span>
        -   <span class="simpara"><span
            class="classname">MongoDB\\Driver\\Exception\\AuthenticationException</span></span>
        -   <span class="simpara"><span
            class="classname">MongoDB\\Driver\\Exception\\ConnectionTimeoutException</span></span>
        -   <span class="simpara"><span
            class="classname">MongoDB\\Driver\\Exception\\SSLConnectionException</span>
            (deprecated)</span>
    -   <span class="simpara"><span
        class="classname">MongoDB\\Driver\\Exception\\EncryptionException</span></span>
    -   <span class="simpara"><span
        class="classname">MongoDB\\Driver\\Exception\\ServerException</span></span>
        -   <span class="simpara"><span
            class="classname">MongoDB\\Driver\\Exception\\CommandException</span></span>
        -   <span class="simpara"><span
            class="classname">MongoDB\\Driver\\Exception\\ExecutionTimeoutException</span></span>
        -   <span class="simpara"><span
            class="classname">MongoDB\\Driver\\Exception\\WriteException</span></span>
            -   <span class="simpara"><span
                class="classname">MongoDB\\Driver\\Exception\\BulkWriteException</span></span>
