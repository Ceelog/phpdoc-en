...
| Version | Description                                                               |
|---------|---------------------------------------------------------------------------|
| 5.3.19  | <span class="function">imagecreatefromxpm</span> is available on Windows. |
...
| Version | Description                                                                    |
|---------|--------------------------------------------------------------------------------|
| 5.4.0   | Added support for passing a stream <span class="type">resource</span> to `to`. |
...
`space`  
Allows you to change the default value of a space in a font. This amount
is added to the normal value and can also be negative. Expressed in
...
also be negative. Expressed in character space units, where 1 unit is
...
**Example \#1 <span class="function">imagepsbbox</span> usage**
...
> **Note**: <span class="simpara">This function is only available if PHP
> is compiled using **--with-t1lib\[=DIR\]**. </span>
...
to define the encoding is to set ps.default\_encoding in the
...
**Example \#1 <span class="function">imagepsencodefont</span> example**
...
**Example \#1 <span class="function">imagepsextendfont</span> example**
...
<span class="function">imagepsfreefont</span> frees memory used by a
...
**Example \#1 <span class="function">imagepsfreefont</span> example**
...
**Example \#1 <span class="function">imagepsloadfont</span> example**
...
**Example \#1 <span class="function">imagepsslantfont</span> example**
...
pixels with the color `background` are actually painted, so the
...
`antialias_steps`  
Allows you to control the number of colours used for antialiasing text.
Allowed values are 4 and 16. The higher value is recommended for text
sizes lower than 20, where the effect in text quality is quite visible.
...
**Example \#1 <span class="function">imagepstext</span> usage**
...
| 5.5.0   | This function is now affected by the interpolation method set by the <span class="function">imagesetinterpolation</span> function. |
...
-   [imagepsbbox](/ref/image.html#imagepsbbox) — Give the bounding box
    of a text rectangle using PostScript Type1 fonts
-   [imagepsencodefont](/ref/image.html#imagepsencodefont) — Change the
    character encoding vector of a font
-   [imagepsextendfont](/ref/image.html#imagepsextendfont) — Extend or
    condense a font
...
-   [imagepsslantfont](/ref/image.html#imagepsslantfont) — Slant a font
-   [imagepstext](/ref/image.html#imagepstext) — Draws a text over an
    image using PostScript Type1 fonts
